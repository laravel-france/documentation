...
Plus d'informations sur la peuplement de base de données dans la section [migrations et populations](/4.0/migrations#database-seeding) de la documentation.
